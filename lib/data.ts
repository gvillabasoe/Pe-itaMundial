...
export const ACTIVITY = [
  { text: "@Laura_G sube al 2º puesto", time: "Hace 2h" },
  { text: "Jornada 1 actualizada", time: "Hace 6h" },
  { text: "Clasificación al día", time: "Hace 1d" },
  { text: "Nuevos picks cargados", time: "Hace 2d" },
];
